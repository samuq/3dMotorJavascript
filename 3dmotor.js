...
var motor = (function () {
    ...
    function Vector3() {
        ...
        function getLength() {
            this.length = Math.sqrt(Math.pow(this.vector3[0], 2) + Math.pow(this.vector3[2], 2) + Math.pow(this.vector3[2], 2));
        }
    }
    ...
    function crossMultiply(quat1, quat2) {
        ...
        if ((complex1 === "i" && complex2 === "i") || (complex1 === "j" && complex2 === "j") || (complex1 === "k" && complex2 === "k")) { complexX.complex = 0; }
        else if (complex1 === "j" && complex2 === "k") { complexX.complex = "i"; }
        else if (complex1 === "k" && complex2 === "i") { complexX.complex = "j"; }
        else if (complex1 === "i" && complex2 === "j") { complexX.complex = "k"; }
        else if (complex1 === "k" && complex2 === "j") { complexX.complex = "i"; scalar1 *= -1; }
        else if (complex1 === "i" && complex2 === "k") { complexX.complex = "j"; scalar1 *= -1; }
        else if (complex1 === "j" && complex2 === "i") { complexX.complex = "k"; scalar1 *= -1; }
        complexX.scalar = scalar1 * scalar2;
        return complexX;
    }

    function dotProduct(vector1, vector2) {
        var a = vector1.vector3[0] * vector2.vector3[0] + vector1.vector3[1] * vector2.vector3[1] + vector1.vector3[2] * vector2.vector3[2];
        return a;
    }
    ...
    function getLength(vector) {
        var length = Math.sqrt(Math.pow(vector.vector3[0], 2) + Math.pow(vector.vector3[1], 2) + Math.pow(vector.vector3[2], 2));
        return length;
    }
    ...
    function mesh() {
        ...
        function edgesAndFacesPlaneGrid(x) {
            ...
            for (var i = 0; i < (x - 1) ; i++) {
                ...
                for (var j = 0; j < (y - 1) ; j++) {
                    ...
                    var face2 = new Face();
                    if (everyOtherY) {
                        face.initialize(this.vertices[i * y + j].vector3, this.vertices[i * y + j + 1].vector3, this.vertices[i * y + j + y + 1].vector3);
                        face.initializeUvs(this.Uvs[i * y + j].vector2, this.Uvs[i * y + j + 1].vector2, this.Uvs[i * y + j + y + 1].vector2);
                        this.faces.push(face);
                        face2.initialize(this.vertices[i * y + j].vector3, this.vertices[i * y + j + y + 1].vector3, this.vertices[i * y + j + y].vector3);
                        face2.initializeUvs(this.Uvs[i * y + j].vector2, this.Uvs[i * y + j + y + 1].vector2, this.Uvs[i * y + j + y].vector2);
        ...
        function edgesAndFacesPlane() {
            ...
            var face = new Face();
            face.initialize(this.vertices[0].vector3, this.vertices[1].vector3, this.vertices[2].vector3);
            face.initializeUvs(this.Uvs[0].vector2, this.Uvs[1].vector2, this.Uvs[2].vector2);
            this.faces.push(face);
            var face2 = new Face();
            face2.initialize(this.vertices[1].vector3, this.vertices[3].vector3, this.vertices[2].vector3);
            face2.initializeUvs(this.Uvs[1].vector2, this.Uvs[3].vector2, this.Uvs[2].vector2);
        ...
        function edgesAndFaces() {
            this.faces.splice(0, this.faces.length);
            this.edges.splice(0, this.edges.length);
            for (var i = 0; i <= this.slices; i++) {//document.write(this.slices);
                for (var j = 0; j < this.sections; j++) {//document.write("i"+i+"j"+j);
                    ...
                    if (i - 1 === 0) {
                        ...
                        if (j === this.sections - 1) {//document.write("jsec:");document.write(j);
                        ...
                        else if (j >= 0 && j !== this.sections - 1) {//document.write("j:");document.write(j-1);
                    ...
                    else if (i > 1 && i !== this.slices) {//document.write("i>1:");document.write(i);
                        var index = (i - 1) * this.sections + 1;
                        var index2 = (i - 2) * this.sections + 1;
                        if (j === this.sections - 1) {//document.write(j);
                        ...
                        if (j === this.sections - 1) {
                        ...
                        else if (j >= 0 && j !== this.sections - 1) {//document.write("i=slices"+j);
                            //if(this.slices>2){
                            ...
                            var c = this.vertices[index - this.sections + j + 1].vector3.slice();
                            var face = new Face();
                            face.initialize(a, b, c);
                            this.faces.push(face);
    ...
    function startscene() {
        ...
        var myvar = setInterval(function () { rotateObjects(scene1) }, 50);
    }
    ...
    function complexMultiplication(complex1, complex2, scalar1, scalar2) {
        var complexX = new complex(1);
        if (complex1 === 1 && complex2 === 1) { complexX.complex = 1; }
        else if ((complex1 === "i" && complex2 === "i") || (complex1 === "j" && complex2 === "j") || (complex1 === "k" && complex2 === "k")) { complexX.complex = 1; scalar1 *= -1; }
        else if ((complex1 === 1 && complex2 === "i") || (complex1 === "i" && complex2 === 1) || (complex1 === "j" && complex2 === "k")) { complexX.complex = "i"; }
        else if ((complex1 === 1 && complex2 === "j") || (complex1 === "j" && complex2 === 1) || (complex1 === "k" && complex2 === "i")) { complexX.complex = "j"; }
        else if ((complex1 === 1 && complex2 === "k") || (complex1 === "k" && complex2 === 1) || (complex1 === "i" && complex2 === "j")) { complexX.complex = "k"; }
        else if (complex1 === "k" && complex2 === "j") { complexX.complex = "i"; scalar1 *= -1; }
        else if (complex1 === "i" && complex2 === "k") { complexX.complex = "j"; scalar1 *= -1; }
        else if (complex1 === "j" && complex2 === "i") { complexX.complex = "k"; scalar1 *= -1; }
        complexX.scalar = scalar1 * scalar2;
    ...
    function quaternionMultiplication(quaternion1, quaternion2) {//document.write("multiply:");
        var quaternionX = new quaternion();
        var complexA;
        for (var i = 0; i < quaternion1.quaternion.length; i++) {
            for (var j = 0; j < quaternion2.quaternion.length; j++) {
                complexA = complexMultiplication(quaternion1.quaternion[i].complex, quaternion2.quaternion[j].complex, quaternion1.quaternion[i].scalar, quaternion2.quaternion[j].scalar);

                for (var k = 0; k < quaternionX.quaternion.length; k++) {
                    if (complexA.complex === quaternionX.quaternion[k].complex) {
                        quaternionX.quaternion[k] = complexAdd(quaternionX.quaternion[k], complexA);
                    }
                }
            }
        }
        ...
        for (var i = 0; i < scene1.objects.length; i++) {
            for (var j = 0; j < scene1.objects[i].faces.length; j++) {
                for (var k = 0; k < scene1.objects[i].faces[j].face.length; k++) {
                    scene1.objects[i].faces[j].face[k] = applyRotation(scene1.objects[i].faces[j].face[k], axis1, angle);
                }
            }
    ...
    function rotatePlanes(scene1, images, rotDegree1) {
        ...
        if (rotIndex <= 0 && rotDegree1 < 0) { rotIndex = images.length; }
        if (rotIndex >= images.length && rotDegree1 > 0) { rotIndex = 0; }
        ...
        for (var i = 0; i < scene1.objects.length; i++) {
            for (var j = 0; j < scene1.objects[i].faces.length; j++) {
                for (var k = 0; k < scene1.objects[i].faces[j].face.length; k++) {
                    scene1.objects[i].faces[j].face[k] = applyRotation(scene1.objects[i].faces[j].face[k], axis1, -rotDegree1);
                }
            }
            scene1.objects[i].calculateFaceNormals();
        }
    ...
    function rotatePlaneGrids(scene1, images1, rotDegree1) {
        ...
        console.log(rotDegree);
        //console.log(rotIndex);
        if (rotIndex <= 0 && rotDegree1 < 0) { rotIndex = images1.length; }
        if (rotIndex >= images1.length && rotDegree1 > 0) { rotIndex = 0; }
        //if (rotIndex <= 0 && rotDegree1 > 0) { rotIndex++; }
        if (rotDegree >= (360 / images1.length) * (rotIndex + 1) && rotDegree1 > 0) {
            clearInterval(myvar);
            rotate = false;
            //if (rotIndex >= images.length) rotIndex = 0;
            rotIndex++;
        ...
        if (rotIndex == images1.length) { texts = images1[0].id.toString().split("_"); }
        else {
            texts = images1[rotIndex].id.toString().split("_");
        }
        text = texts[2].split(".");
        description = document.getElementById("description");
        description.innerHTML = '<i>' + texts[1] + '</i>' + '<br>' + text[0] + ", " + texts[0];
    }
    function rotateObjects1(scene1) {
        for (var i = 0; i < scene1.objects.length; i++) {
            for (var j = 0; j < scene1.objects[i].edges.length; j++) {
                ...
                axis1.initialize(0, 1, 0);
                angle = 2;
                scene1.objects[i].edges[j].edge[0] = applyRotation(scene1.objects[i].edges[j].edge[0], axis1, angle);
                scene1.objects[i].edges[j].edge[1] = applyRotation(scene1.objects[i].edges[j].edge[1], axis1, angle); document.write("draw");
            }
        }
        drawEdges(scene1);
    ...
    function polygon(face, width, height, color, context) {
        ...
        context.moveTo(face.imageCoords[0].vector2[0] * width, height - face.imageCoords[0].vector2[1] * height);
        for (var i = 1; i < face.imageCoords.length; i++) {
            //document.write(face.imageCoords[i].vector2[0]*);
            context.lineTo(face.imageCoords[i].vector2[0] * width, height - face.imageCoords[i].vector2[1] * height);
    ...
    function shade(color, light, angle, distance) {
        ...
        //document.write(strength);
        for (var i = 0; i < 3; i++) {
            color1.push(color.vector3[i] * strength) + (strength * light.color.vector3[i]);//document.write(color1[i]);
        }
    ...
    function centerPoint(face) {
        ...
        var x = (face.face[0].vector3[0] + face.face[1].vector3[0] + face.face[2].vector3[0]) / 3;
        var y = (face.face[0].vector3[1] + face.face[1].vector3[1] + face.face[2].vector3[1]) / 3;
        var z = (face.face[0].vector3[2] + face.face[1].vector3[2] + face.face[2].vector3[2]) / 3;
    ...
    function applyCameraView(point, camera) {
        ...
        var zAxis = new Vector3();
        zAxis.initialize(0, 0, 1);
        var newPosition = applyRotation(position, xAxis, camera.transform.rotation.vector3[0] / -2);
        newPosition = applyRotation(newPosition, yAxis, camera.transform.rotation.vector3[1] / -2);
        newPosition = applyRotation(newPosition, zAxis, camera.transform.rotation.vector3[2] / -2);
        return newPosition;
    }
    ...
    function drawVertices(scene1) {
        ...
        for (var i = 0; i < scene1.objects.length; i++) {
            for (var j = 0; j < scene1.objects[i].vertices.length; j++) {
                ...
                if (pointToDraw !== undefined) {//document.write(pointToDraw.vector2[0]);
                    circle(pointToDraw.vector2[0] * width, height - pointToDraw.vector2[1] * height, 3, "gold", konteksti);
    ...
    var next = function (imagearray) {
        ...
        myvar = setInterval(function () { rotatePlaneGrids(scene1, imageArray1, 1.5) }, 40);
    }
        ...
        var readyStateCheckInterval1 = setInterval(function () {
            ...
            if (imageArray1[images.length - 1].complete) {
                ...
                for (var i = 0; i < images.length; i++) {
                    ...
                    var x = (width * Math.sin((360 / images.length) * (Math.PI / 180))) / (2 * Math.sin(((180 - (360 / images.length)) / 2) * (Math.PI / 180)));
                    console.log(x);
                    var ratio2 = x / width;
                    ...
                    for (var j = 0; j < plane.faces.length; j++) {
                        for (var k = 0; k < plane.faces[j].face.length; k++) {
                            ...
                            plane.faces[j].face[k] = applyRotation(plane.faces[j].face[k], axis1, i * (360 / images.length));
                        }
                ...
                document.getElementById('next').setAttribute('class', 'btn btn-default');
                document.getElementById('prev').setAttribute('class', 'btn btn-default');
                    ...
                    imageArray1[images.length - 1].onload = function () {
                        ...
                        for (var i = 0; i < images.length; i++) {
                            ...
                            for (var j = 0; j < plane.faces.length; j++) {
                                for (var k = 0; k < plane.faces[j].face.length; k++) {
                                    console.log(plane.faces[j].face[k].vector3[0]);
                                    plane.faces[j].face[k] = applyRotation(plane.faces[j].face[k], axis1, j * (360 / images.length));
                                }
    ...
    function drawEdges(scene1) {//document.write("draw1");
        var konteksti1 = document.getElementById("view").getContext("2d");
        height = canvas.height;
        width = canvas.width;//document.write("draw2");
        //konteksti1.clearRect(0, 0, canvas.width, canvas.height);

        for (var i = 0; i < scene1.objects.length; i++) {//document.write("draw");
            for (var j = 0; j < scene1.objects[i].edges.length; j++) {//document.write("draw");document.write(scene1.objects[0].edges[7].edge[1].vector3[2]);
                var pointToDraw1 = projection(MainCamera, scene1.objects[i].edges[j].edge[0]);
                var pointToDraw2 = projection(MainCamera, scene1.objects[i].edges[j].edge[1]);
                if (pointToDraw1 !== undefined && pointToDraw2 !== undefined) {//document.write("draw");
                    line(pointToDraw1.vector2[0] * width, height - pointToDraw1.vector2[1] * height, pointToDraw2.vector2[0] * width, height - pointToDraw2.vector2[1] * height, 1, konteksti1, "red");
    ...
    function PlaneGridImage(ctx, tex, face, uvs, index, render, first, cornerLL, cornerUL, cornerLR, cornerUR, last, firstUL,currentLeft,currentRight) {
            ...
            if ((YUL - YLL) <= (YUR - YLR)) {
                ...
                if (index == 0) {
                    ...
                    if (y1 < y2) {
                        ...
                        f = height - (y1) * height - (1 - v1) * d * height +(y2-y1)*(y4-1) * height;

                    }
                    else {
                        g = ((y1 - y2) * (picSizeY) * a) / (x2 - x0); // (x2 - x1);
                        f = height - (y1) * height - (1 - v1) * d * height - (y1-y2)*(y4-1) * height;
                    }
                    b = g;
                    c = 0;
                    ...
                    if (y0 < y2) {
                        ...
                        f = height - (y1) * height - (1 - v1) * d * height + (y2 - y0) * y4*height;
                    }
                    else {
                        ...
                        f = height - (y1) * height - (1 - v1) * d * height - (y0 - y2) * y4 * height//*add;
                    }
                    b = g;
                    c = 0;
                ...
                if (index == 0) {
                    ...
                    if (y0 < y2) {
                        ...
                        f = height - (y1) * height - (1 - v1) * d * height - (y0 - y2) * y4 * height;
    ...
    function drawPlanes(scene1, images) {
        ...
        for (var i = 0; i < scene1.objects.length; i++) {
            for (var j = 0; j < scene1.objects[i].faces.length; j++) {
                ...
                var face = new Face();
                for (var k = 0; k < scene1.objects[i].faces[j].face.length; k++) {
                    var point = applyCameraView(scene1.objects[i].faces[j].face[k], MainCamera);
                    points.push(point);
                }
                face.initialize(points[0].vector3, points[1].vector3, points[2].vector3);
    ...
    function drawPlaneGrids(scene1, images) {
        ...
        for (var p = 0; p < faceCoords.length; p++) {
            ...
            for (var q = 0; q < faceCoords[p].length; q++) {
                if (q % 2 == 0 && (q / 2) % (y3 - 1) == 0) { y4++; x5 = 0; }
                if (q % 2 == 0) {
                    x5++; //console.log("x5:", x5);
                }
                PlaneGridImage(konteksti, images[p], faceCoords[p][q], uvs[p][q], q, willRender[p][q], faceCoords[p][0],
                 faceCoords[p][(y4 - 1) * (y3 - 1) * 2], faceCoords[p][((y4 - 1) * (y3 - 1) * 2 + (y3 - 1) * 2 - 2)], 
                faceCoords[p][(y4 - 1) * (y3 - 1) * 2 + 1], faceCoords[p][((y4 - 1) * (y3 - 1) * 2 + (y3 - 1) * 2 - 1)], 
                faceCoords[p][faceCoords[p].length - 1], faceCoords[p][(((y3 - 1) * 2) - 2)],faceCoords[p][(x5-1)*2],
    ...
    function drawPolygons(scene1) {
        ...
        for (var p = 0; p < faceCoords.length; p++) {
            ...
            for (var a = 0; a < scene1.lights.length; a++) {
                ...
                var direction = substractVectors(faceCoords[p].center, scene1.lights[a].transform.position);//document.write(faceCoords[p].center.vector3);
